...
class JSONStorageService:
    ...
    def save_document_analysis(self, session_id: str, analysis_data: Dict[str, Any]) -> str:
    ...
    def update_page_analysis(self, session_id: str, page_number: int, new_analysis: str) -> bool:
